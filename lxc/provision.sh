...
#
# Usage:
#   bash <(curl -fsSL https://raw.githubusercontent.com/scottdkey/jellyfin/main/lxc/provision.sh) <vmid> [options]
#
# Options:
...
REPO_RAW="https://raw.githubusercontent.com/scottdkey/jellyfin/${BRANCH}"
